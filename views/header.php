        ...
        $(document).ready(function() {
            ...
            var checkScrollBar = function() {
                if ($(window).width() <= 960) {
                    ...
                    if ($(this).scrollTop() < 1 && element.classList.contains('show')) {
                        $("#btn-cose").click();
                    }
                }
            }
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse ms-5 d-flex justify-content-start" id="navbarColor03">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 " id="linhaNav">
                    <li class="nav-item">
                        <a class="nav-link active" id="home-id" aria-current="page" href="<?= $actual_link ?>/home">
                            HOME
                            <div class="bar-nav-link"></div>
                        </a>
                    </li>
                    <li class="nav-item ">
                        <a class="nav-link" id="sobre-btn" href="#sobre">
                            SOBRE
                            <div class="bar-nav-link"></div>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="noticia-id" href="#novidades">
                            NOVIDADES
                            <div class="bar-nav-link"></div>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="galeria-id" href="#galeria">
                            GALERIA
                            <div class="bar-nav-link"></div>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="contato-id" href="#contato">
                            CONTATO
                            <div class="bar-nav-link"></div>
                        </a>
                    </li>
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top some-pc">
        ...
        <button class="navbar-toggler" type="button" data-toggle="collapse" id="btn-cose" data-target="#navbarColor01" aria-controls="navbarColor01" aria-expanded="false" aria-label="Toggle navigation" id="nav-blue" onclick="alteracor()">
            <span class="navbar-toggler-icon"></span>
        </button>
        ...
        <div class="collapse navbar-collapse" id="navbarColor01">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 " id="linhaNav">
                <li class="nav-item">
                    <a class="nav-link active" id="home-id-mobile" aria-current="page" href="<?= $actual_link ?>/home">
                        HOME
                        <div class="bar-nav-link"></div>
                    </a>
                </li>
                <li class="nav-item ">
                    <a class="nav-link" id="sobre-btn-mobile" href="#sobre">
                        SOBRE
                        <div class="bar-nav-link"></div>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="noticia-id-mobile" href="#novidades">
                        NOVIDADES
                        <div class="bar-nav-link"></div>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="galeria-id-mobile" href="#galeria">
                        GALERIA
                        <div class="bar-nav-link"></div>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="contato-id-mobile" href="#contato">
                        CONTATO
                        <div class="bar-nav-link"></div>
                    </a>
                </li>
    ...
    <script>
        ...
        /*MOBILE */
        $('#sobre-btn-mobile').on('click', function(event) {
            $(this).addClass('active');
            $("#home-id-mobile").removeClass('active');
            $("#contato-id-mobile").removeClass('active');
            $("#galeria-id-mobile").removeClass('active');
            $("#noticia-id-mobile").removeClass('active');
        });

        $('#contato-id-mobile').on('click', function(event) {
            $(this).addClass('active');
            $("#home-id-mobile").removeClass('active');
        ...
        $('#noticia-id-mobile').on('click', function(event) {
            $(this).addClass('active');
            $("#home-id-mobile").removeClass('active');
            $("#sobre-btn-mobile").removeClass('active');
            $("#contato-id-mobile").removeClass('active');
        ...
        $('#galeria-id-mobile').on('click', function(event) {
            $(this).addClass('active');
            $("#home-id-mobile").removeClass('active');
            $("#sobre-btn-mobile").removeClass('active');
            $("#noticia-id-mobile").removeClass('active');
    ...
    <script>
        $(document).ready(function() {
            ...
            if (url == "https://cuidadoratianani.com.br/home#novidades" || url == "http://cuidadoratianani.com.br/home#novidades") {
                $("#noticia-id").addClass('active');
                $("#home-id").removeClass('active');
                $("#sobre-btn").removeClass('active');
                $("#contato-id").removeClass('active');
                $("#galeria-id").removeClass('active');
            } else if (url == "https://cuidadoratianani.com.br/home#contato" || url == "http://cuidadoratianani.com.br/home#contato") {
                $("#contato-id").addClass('active');
                $("#home-id").removeClass('active');
                $("#sobre-btn").removeClass('active');
                $("#noticia-id").removeClass('active');
                $("#galeria-id").removeClass('active');
            } else if (url == "https://cuidadoratianani.com.br/home#galeria" || url == "http://cuidadoratianani.com.br/home#contato") {
                $("#galeria-id").addClass('active');
                $("#home-id").removeClass('active');
                $("#sobre-btn").removeClass('active');
                $("#noticia-id").removeClass('active');
                $("#contato-id").removeClass('active');
            } else if (url == "https://cuidadoratianani.com.br/home#sobre" || url == "http://cuidadoratianani.com.br/home#contato") {
                $("#sobre-id").addClass('active');
                $("#home-id").removeClass('active');
                $("#contato-id").removeClass('active');
                $("#galeria-id").removeClass('active');
                $("#noticia-id").removeClass('active');
