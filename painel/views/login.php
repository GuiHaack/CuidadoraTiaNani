...
<head>
    ...
    <title><?= $configuracoes['nome'] ?>Painel Administrativo</title>
...
<body class="hold-transition login-page" style="background-color: #f73d3d;">
    <div class="login-box">
        <!-- /.login-logo -->
        <div class="card card-outline card-primary" style="border-top: 0; border-radius: 20px;">
            <div class="card-header text-center" style="background-color: #f25a5b;">
                <div class="logo">
                    <img width="300" src="https://cuidadoratianani.com.br/assets/images/logo/Cuidadora-Nani-Logotipo.jpg">
                </div>
            </div>
            <div class="card-body">
                ...
                <form action="vl" method="POST" name="formulario" id="formulario">
                    <div class="form-group">
                        <label>Usuário</label>
                        <input type="type" class="form-control" required name="login" placeholder="Digite o usuário">
                    </div>
                    <div class="form-group">
                        <label>Senha</label>
