<section class="content-header" style="padding-bottom: 5px;">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1>Galeria</h1>
        <a class="btn btn-success" href="<?= $actual_link ?>/painel/adicionar-foto"><i class="fal fa-image pe-1"></i>Adicionar Imagem</a>
      </div>
      <div class="col-sm-6">
          ...
          <?php foreach ($galeria as $proj) { ?>
            <tr>
              ...
              <td class="text-center project-actions" style="text-align: end !important; padding-right: 10%;">
                <a class="btn btn-info btn-sm" href="<?= $actual_link ?>/painel/editar-imagem/<?= $proj["id"] ?>"><i class="fas fa-pencil-alt"></i> Editar</a>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    Você deseja confirmar a exclusão da foto <?= $proj["id"] ?>?
                  </div>
                  <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
                    <a href="<?= $actual_link ?>/painel/apagar-foto/<?= $proj["id"] ?>">
