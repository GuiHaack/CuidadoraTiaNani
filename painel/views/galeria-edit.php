...
<section class="content">
    <form id="form" role="form" action="<?= $actual_link ?>/painel/editar-imagem/<?= $projeto['id'] ?>/action" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <div class="text-left">
                                ...
                                <input type="submit" value="Editar Foto" class="btn btn-success">
                            </div>
                        </div>
                    </div>
                </div>
