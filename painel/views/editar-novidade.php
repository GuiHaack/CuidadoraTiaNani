...
<section class="content">
    <form id="form" role="form" action="<?= $actual_link ?>/painel/editar-novidade/<?= $colaborador['id'] ?>/action" method="POST" enctype="multipart/form-data">
                ...
                <div class="card card-primary card-outline">
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" id="nome" value="<?= $colaborador['titulo'] ?>" class="form-control" required name="nome">
                        </div>
                        <div class="form-group">
                            <label for="data">Data</label>
                            <input type="text" id="data" value="<?= $colaborador['data'] ?>" class="form-control" required name="data">
                        </div>
                        <div class="form-group">
                            <label for="texto">Texto</label>
                            <textarea type="text" id="texto" class="form-control" required name="texto"><?= $colaborador['conteudo'] ?></textarea>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-5">
                <div class="card card-primary card-outline">
                    <div class="form-group">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <?php $temDestaque = (isset($colaborador['imagem']) and $colaborador['imagem'] != '') ? true : false;
                                if ($temDestaque) { ?>
                                    <div class="col-md-12">
                                        <div class="img-item">
